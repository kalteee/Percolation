...
Let us consider the special case, when the grid is infinte, namely $\mathbb{Z}^2$. The initial question of the problem is, for which critical value of p will there be a connected component (in the realization) with infinite cardinality. (In further readings it is called an open-cluster). 
